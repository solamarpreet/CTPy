...
def q3():
    dict = {
            'qnum'  :   '3',
            'qtext' :   'Which element in the list returned by game.data(3) is at index position 37?',
...
def q4():
    dict = {
            'qnum'  :   '4',
            'qtext' :   'Return a string that contains the characters starting at index 10 and going upto but not including the character at index 25 in the string generated by game.data(4) function.  ',
